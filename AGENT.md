...
├── examples/          # samples 01..47, run from the root with run-example_NN, plus image/ (the shared usako.png asset)
...
#   43_game_inventory / 44_fixed_framebuffer / 45_path_drawing / 46_style_gallery /
#   47_screen_layout

...
**File: result_type_propagation.zig**
```zig
...
**File: result_location_interfering_with_swap.zig**
```zig
...
/home/ci/actions-runner/_work/zig-bootstrap/out/host/lib/zig/std/testing.zig:601:14: 0x1030019 in expect (std.zig)
 ...
 ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/result_location_interfering_with_swap.zig:10:5: 0x103013f in test.attempt to swap array elements with array initializer (result_location_interfering_with_swap.zig)
 try expect(arr[1] == 1); // fails
 ^
0 passed; 0 skipped; 1 failed.
error: the following test command failed with exit code 1:
/home/ci/actions-runner/_work/zig-bootstrap/out/zig-local-cache/o/03aeff0e6a6ffec196d1f872a5aa9856/test --seed=0xa846f29
```

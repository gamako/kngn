...
**File: test_coerce_error_subset_to_superset.zig**
```zig
...
**File: test_coerce_error_superset_to_subset.zig**
```zig
const FileOpenError = error{
 AccessDenied,
 OutOfMemory,
...
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/test_coerce_error_superset_to_subset.zig:16:12: error: expected type 'error{OutOfMemory}', found 'error{AccessDenied,FileNotFound,OutOfMemory}'
 return err;
 ^~~
...
**File: single_value_error_set_shortcut.zig**
```zig
...
**File: single_value_error_set.zig**
```zig
...
**File: error_union_parsing_u64.zig**
```zig
const std = @import("std");
...
**File: handle_error_with_catch_block.zig.zig**
```zig
const parseU64 = @import("error_union_parsing_u64.zig").parseU64;
...
**File: handle_all_error_scenarios.zig**
```zig
fn doAThing(str: []u8) void {
...
**File: handle_some_error_scenarios.zig**
```zig
...
**File: handle_no_error_scenarios.zig**
```zig
...
**File: test_errdefer_capture.zig**
```zig
const std = @import("std");
...
**File: test_merging_error_sets.zig**
```zig
const A = error{
 NotDir,
...
**File: test_inferred_error_sets.zig**
```zig
...
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:34:5: 0x113c0dc in bang1 (error_return_trace.zig)
 return error.FileNotFound;
 ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:22:5: 0x113c126 in baz (error_return_trace.zig)
 try bang1();
 ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:38:5: 0x113c15c in bang2 (error_return_trace.zig)
 return error.PermissionDenied;
 ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:30:5: 0x113c206 in hello (error_return_trace.zig)
 try bang2();
 ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:17:31: 0x113c2de in bar (error_return_trace.zig)
 error.FileNotFound => try hello(),
 ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:7:9: 0x113c394 in foo (error_return_trace.zig)
 try bar();
 ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/error_return_trace.zig:2:5: 0x113c45b in main (error_return_trace.zig)
 try foo(12);
 ^
```
...
$ ./stack_trace
thread 3100062 panic: PermissionDenied
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/stack_trace.zig:38:5: 0x113e07a in bang2 (stack_trace.zig)
 @panic("PermissionDenied");
 ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/stack_trace.zig:30:10: 0x113e60c in hello (stack_trace.zig)
 bang2();
 ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/stack_trace.zig:17:14: 0x113e033 in bar (stack_trace.zig)
 hello();
 ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/stack_trace.zig:7:12: 0x113db28 in foo (stack_trace.zig)
 bar();
 ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/stack_trace.zig:2:8: 0x113cf91 in main (stack_trace.zig)
 foo(12);
 ^

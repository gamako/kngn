...
- `*[N]T` - pointer to N items, same as single-item pointer to an array. Supports index syntax: `array_ptr[i]`
...
- `[]T` - is a slice (a fat pointer, which contains a pointer of type `[*]T` and a length). Supports index syntax: `slice[i]`
...
**File: test_single_item_pointer.zig**
```zig
...
**File: test_pointer_arithmetic.zig**
```zig
const expect = @import("std").testing.expect;
...
**File: test_comptime_pointers.zig**
```zig
const expect = @import("std").testing.expect;
...
**File: test_integer_pointer_conversion.zig**
```zig
const expect = @import("std").testing.expect;
...
**File: test_comptime_pointer_conversion.zig**
```zig
const expect = @import("std").testing.expect;
...
**File: test_variable_alignment.zig**
```zig
const std = @import("std");
...
**File: test_variable_func_alignment.zig**
```zig
const expect = @import("std").testing.expect;
...
**File: test_incorrect_pointer_alignment.zig**
```zig
const std = @import("std");
...
1/1 test_incorrect_pointer_alignment.test.pointer alignment safety...thread 3101857 panic: incorrect alignment
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/test_incorrect_pointer_alignment.zig:10:68: 0x102d266 in foo (test_incorrect_pointer_alignment.zig)
 const int_slice = std.mem.bytesAsSlice(u32, @as([]align(4) u8, @alignCast(slice4)));
 ^
/home/ci/actions-runner/_work/zig-bootstrap/zig/doc/langref/test_incorrect_pointer_alignment.zig:6:31: 0x102d0b1 in test.pointer alignment safety (test_incorrect_pointer_alignment.zig)
 try std.testing.expect(foo(bytes) == 0x11111111);
 ^
/home/ci/actions-runner/_work/zig-bootstrap/out/host/lib/zig/compiler/test_runner.zig:240:25: 0x1158aff in mainTerminal (test_runner.zig)
 if (test_fn.func()) |_| {
 ^
/home/ci/actions-runner/_work/zig-bootstrap/out/host/lib/zig/compiler/test_runner.zig:69:28: 0x1153336 in main (test_runner.zig)
 return mainTerminal();
 ^
/home/ci/actions-runner/_work/zig-bootstrap/out/host/lib/zig/std/start.zig:618:22: 0x114ea0c in callMain (std.zig)
 root.main();
 ^
/home/ci/actions-runner/_work/zig-bootstrap/out/host/lib/zig/std/start.zig:232:5: 0x114e4e1 in _start (std.zig)
 asm volatile (switch (native_arch) {
 ^
error: the following test command crashed:
/home/ci/actions-runner/_work/zig-bootstrap/out/zig-local-cache/o/8b73d02a11c8839e5c5a2babf304bbef/test --seed=0xc37d66c3
```
...
**File: sentinel-terminated_pointer.zig**
```zig
const std = @import("std");
...
pub extern "c" fn printf(format: [*:0]const u8, ...) c_int;
 ^~~~~~~~~~~~~
referenced by:
 callMain [inlined]: /home/ci/actions-runner/_work/zig-bootstrap/out/host/lib/zig/std/start.zig:627:37
 callMainWithArgs [inlined]: /home/ci/actions-runner/_work/zig-bootstrap/out/host/lib/zig/std/start.zig:587:20
 main: /home/ci/actions-runner/_work/zig-bootstrap/out/host/lib/zig/std/start.zig:602:28

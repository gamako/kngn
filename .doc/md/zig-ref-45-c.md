...
**File: test_variadic_function.zig**
```zig
...
**File: test_defining_variadic_function.zig**
```zig
const std = @import("std");
const testing = std.testing;
const builtin = @import("builtin");

...
pub fn build(b: *std.Build) void {
    ...
    for ([_]std.builtin.OptimizeMode{ .ReleaseFast, .ReleaseSmall }) |guard_optimize| {
        ...
        const cases = [_]struct { case: []const u8, message: []const u8 }{
            ...
            .{ .case = "display_only_open_popup", .message = "openPopup is not allowed in a display-only subtree" },
            .{ .case = "display_only_close_popup", .message = "closePopup is not allowed in a display-only subtree" },
            .{ .case = "display_only_open_popup_stacked", .message = "openPopupStacked is not allowed in a display-only subtree" },
            .{ .case = "display_only_close_popup_stacked", .message = "closePopupStacked is not allowed in a display-only subtree" },

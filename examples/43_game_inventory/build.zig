...
pub fn build(b: *std.Build) void {
    ...
    platform.buildStandalone(b, target, optimize, .{
        .base_name = "example_43_game_inventory",
        ...
        // Opt in the real gamepad backend, the same as examples/22_gamepad (the harness's
        // simulated pads work regardless; this only matters for a native, non-headless run).
        .link_gamepad = true,

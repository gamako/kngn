...
pub fn build(b: *std.Build) void {
    ...
    // モジュールを追加
    exe_objc.root_module.addImport("sprite", sprite_module);
    exe_objc.root_module.addImport("keyboard", keyboard_module);
    ...
    // モジュールを追加
    exe_swift.root_module.addImport("sprite", sprite_module);
    exe_swift.root_module.addImport("keyboard", keyboard_module);
    ...
    // モジュールを追加
    exe_metal.root_module.addImport("sprite", sprite_module);
    exe_metal.root_module.addImport("keyboard", keyboard_module);
